...
## Why this published fork exists
...
A PR is present with an equivalent change since August 2023 along with an issue against this requirement but nothing has been addressed.
Hence why I have published this fork.
   ...
   jobs:
     publish:
       ...
       steps:
         ...
         - name: Publish to Cloudflare Pages
           uses: nader-eloshaiker/cloudflare-pages-action@v1.0.0
           with:
